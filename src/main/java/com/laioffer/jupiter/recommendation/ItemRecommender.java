...
public class ItemRecommender {
    ...
    //this function is used when we have some user favorite history
    private List<Item> recommendByFavoriteHistory(
        ...
        //Function.identity here is alike str -> str
        ...
        //choose the top numbers of the the favorites
