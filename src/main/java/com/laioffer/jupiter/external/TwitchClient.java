...
public class TwitchClient {
    ...
    private static final String TOKEN = "Bearer lbgy9riq4bhafs3m40l814lvtut5ms";
    ...
    private String searchTwitch(String url){
        ...
        //response handler check null or error from response and return valid response body
        ...
        //try catch block executing request and return response body
        try {
            HttpGet request = new HttpGet(url);
            request.setHeader("Authorization", TOKEN);
            request.setHeader("Client-Id", CLIENT_ID);
            //return response body in string after checked
    ...
    //ObjectMapper convert data to Game[] array
    ...
    //search topGames with limit 0 is default
    ...
    //search specific game from twitch
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            ...
            try {
                //encode game name, e.g. convert space to %20
